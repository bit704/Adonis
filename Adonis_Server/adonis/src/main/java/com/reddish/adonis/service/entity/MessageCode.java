...
public enum MessageCode {
     ...
     * UserInfoMessage
     */
    uif_already_exist(200,"用户ID已存在，无法注册"),
    uif_not_exist(201,"用户ID不存在，无法线上操作"),
    uif_worry_password(202,"密码不正确"),
    uif_no_nickname(203,"消息中未传入新昵称，无法更新"),
    uif_no_password(204,"消息中未传入新密码，无法更新"),
    uif_incomplete_info(205,"注册时未传入完整信息"),
    uif_offline(206,"用户不在线，已经断连，需要重新登录"),
    ...
    fif_already_add(400, "此用户已将您加入好友列表"),
    fif_block(402, "此用户已将您拉黑"),
    fif_reject(403, "此用户拒绝您的好友申请"),
    fif_exist(404, "此用户存在"),
    fif_not_exist(405, "此用户不存在,已注销或从未注册过"),
    fif_online(406, "此用户在线"),
    fif_offline(407, "此用户不在线"),
    fif_your_single(408, "此用户是您的单向好友（您没删它，它删了您）"),
    fif_repeat_add(409, "已经对此用户发送过同样的好友申请"),
    fif_two_way(412,"此用户和您是双向好友"),
    fif_not_two_way(413,"此用户和您不是双向好友")
    ;
