...
public interface DAOFeignClient {
    ...
    void createNewUser(@RequestParam String userId, @RequestParam String nickname, @RequestParam String password);
    ...
    void updateUserPassword(@RequestParam String userId, @RequestParam String password);
    ...
    void createNewFriendship(@RequestParam String subjectId, @RequestParam String objectId, @RequestParam int Status, @RequestParam String customNickname, @RequestParam String memo);

    @GetMapping("/DAO/updateFriendStatus")
    void updateFriendStatus(@RequestParam String subjectId, @RequestParam String objectId, @RequestParam int status);

    @GetMapping("/DAO/updateFriendCustomNickname")
    void updateFriendCustomNickname(@RequestParam String subjectId, @RequestParam String objectId, @RequestParam String customNickname);

    @GetMapping("/DAO/updateFriendMemo")
    void updateFriendMemo(@RequestParam String subjectId, @RequestParam String objectId, @RequestParam String memo);

    // 判断objectId是不是subjectId的单向好友
    @GetMapping("/DAO/judgeFriendshipOneWay")
    boolean judgeFriendshipOneWay(@RequestParam String subjectId, @RequestParam String objectId);
    ...
    Friend queryTheFriend(@RequestParam String subjectId, @RequestParam String objectId);

    @GetMapping("/DAO/deleteFriend")
    void deleteFriend(@RequestParam String subjectId, @RequestParam String objectId);

    @GetMapping("/DAO/saveDialogue")
    void saveDialogue(@RequestParam String senderId, @RequestParam String receiverId, @RequestParam String content, @RequestParam long occurredTime, @RequestParam long lastedTime);

    @GetMapping("/DAO/queryDialogues")
    List<Dialogue> queryDialogues(@RequestParam String senderId, @RequestParam String receiverId);
}
