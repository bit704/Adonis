...
public class UserInfoService {
    ...
    public void handle(UserInfoMessage userInfoMessage, Session session) throws MessageException, UserInfoException {
        ...
        if (type.equals("sign_up")) {
            // 已存在，不可注册
            if (user != null) throw new UserInfoException(ExceptionCode._201);
            ...
            // 校验用户是否存在
            if (user == null) throw new UserInfoException(ExceptionCode._202);
            ...
            if (type.equals("sign_in")) {
                ...
                switch (type) {
                    ...
                    case "change_nickname" -> {
                        ...
                        if (nickname_new == null) throw new UserInfoException(ExceptionCode._205);
                    ...
                    case "change_password" -> {
                        ...
                        if (password_new == null) throw new UserInfoException(ExceptionCode._206);
